        ...
        <div class="max-w-screen-xl mx-auto grid md:grid-cols-3 justify-between items-start gap-6 px-3">
            ...
            <div class="flex flex-col gap-3">
                ...
                <ul class="px-9 flex flex-col gap-3">
                    <li class="flex gap-3">
                        ...
                        <span>
                        Jl. Rengasdengklok Selatan No. 15, Bandung, Jawa Barat
                        </span>
                    </li>
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-3">
                    ...
                    <ul class="px-9 flex flex-col gap-3">
                        <li class="flex gap-3">
                            <span class="font-semibold underline">+62 812-1423-1810</span>
                            <span>
                                Customer Service
                            </span>
                        </li>
                        <li class="flex gap-3">
                            <span class="font-semibold underline">+62 831-7460-2321</span>  
                            <span>
                                Customer Service
                            </span>
                        </li>
